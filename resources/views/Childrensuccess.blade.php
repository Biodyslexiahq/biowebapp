...
<body class="vh-100 overflow-auto antialiased">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
          ...
          <h1 class="centered-text fade-in-text" style="font-family: Chewy;">BioDyslexia your Journey towards Success! </h1>
          <br>
            </section>
            
            <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" centered-slides="true" grab-cursor="true">
              <swiper-slide>
                <img id="slide-1" src="/images/JourneyBM.png" alt="certificate 1"/>
              </swiper-slide>
              <swiper-slide>
                <img id="slide-2" src="/images/JourneyENG.png" alt="certificate 2"/>
              </swiper-slide>
              <swiper-slide>
                <img id="slide-3" src="/images/Empowering.png" alt="certificate 3"/>
              </swiper-slide>
            </swiper-container>
          </div>
