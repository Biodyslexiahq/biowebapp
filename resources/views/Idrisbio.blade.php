...
<body class="vh-100 overflow-auto antialiased staffbio">
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
          ...
          <div class="float-container bg-white w-100 vh-100 overflow-auto ">
            ...
            <h1 class=" fade-in-text centered-text2" style="font-family: Oswald;">Idris A. Akmal biography</h1>
            <br><br>
            <p>Idris A. Akmal, our Chief Operating Officer at BioDyslexia, not only boasts a solid background in Business Administration but also holds certification as a BioDyslexia teacher. With a unique blend of business acumen and specialized expertise in dyslexia education, Idris brings a holistic approach to his role, contributing to both the operational efficiency and the educational mission of BioDyslexia. His commitment to fostering an inclusive learning environment makes him an invaluable asset to our team.</p>
            </section>
            <!--IMAGE HERE-->
            <section class="float-child">
            <img src="/images/bioteam1.JPG" alt="Idris img" class="biography">
            <br><br>
            </section>
