...
<body class="vh-100 overflow-auto antialiased">
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
        ...
        <h1 class="centered-text2 fade-in-text" style="font-family: Oswald;">Why do we use Multisensory?</h1>
        <br>
        <p>It is learning that involves two or more of the senses among the five (sound, sight, feel, smell, taste) in the same activity. This comes naturally as the world we live in is experienced through multisensory stimulation.

            The human brain has evolved to learn and operate optimally in multisensory environments. Hence, multisensory training procedures are close to natural settings and therefore are effective for learning.</p>
        <br>
        </section>
